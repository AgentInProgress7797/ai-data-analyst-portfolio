...
function ArchitectureFlow({
  ...
  const activeNode =
    project.architecture[activeNodeIndex] ??
...
export default function ProjectDashboard() {
  ...
  const activeProjectIndex = portfolioProjects.findIndex(
    (project) => project.id === activeProjectId
  );
  ...
  function goToPreviousProject() {
    ...
    setActiveProjectId(portfolioProjects[previousIndex].id);
  }
  ...
  function goToNextProject() {
    ...
    setActiveProjectId(portfolioProjects[nextIndex].id);
  }
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-10">
        <div className="mb-12 max-w-3xl">
          ...
          <p className="mt-5 max-w-2xl text-sm leading-7 text-mist-600 sm:text-base">
            These projects represent the kind of work I enjoy building—from
            enterprise AI and intelligent automation to analytics and modern
            web applications. Each one reflects the problem, the approach I
            took and the contribution I made.
          </p>
        </div>
        ...
        <div className="relative overflow-hidden rounded-[32px] border border-white/[0.085] bg-[#040908]/80 shadow-[0_40px_130px_rgba(0,0,0,0.36)] backdrop-blur-2xl">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="mt-6">
                <MetricsGrid project={activeProject} />
              </div>
              ...
              <div className="mt-5 grid items-stretch gap-5 xl:grid-cols-[1.06fr_0.94fr]">
                <ArchitectureFlow
