...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="section relative z-10 flex flex-1 flex-col justify-center py-8 lg:py-10">
        <div className="grid items-center gap-12 lg:grid-cols-[1.02fr_0.98fr]">
          ...
          >
            ...
            >
              ...
              <span>{personal.heroEyebrow}</span>
            </motion.p>

            {/* Heading */}
            <motion.h1
              variants={item}
              className="max-w-[700px] text-[clamp(2.7rem,4.45vw,4.2rem)] font-semibold leading-[1.03] tracking-[-0.035em] text-white"
            >
            ...
            <motion.p
              variants={item}
              className="mt-5 max-w-[620px] text-base leading-[1.75] text-mist-300 sm:text-[17px]"
            >
              ...
              <div className="absolute left-1/2 top-[42%] z-20 -translate-x-1/2 -translate-y-1/2">
                ...
                >
                  ...
                  >
                    ...
                    >
                      {/* Black-and-white by default, colour on hover */}
                      <Image
      ...
      <motion.a
        ...
        className="absolute bottom-8 left-1/2 z-20 -translate-x-1/2 text-mist-700 transition-colors duration-300 hover:text-signal-400"
      >
        <ArrowDown
          size={20}
          aria-hidden="true"
